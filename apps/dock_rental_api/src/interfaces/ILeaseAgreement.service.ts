...
export abstract class ILeaseAgreementService {
  ...
  abstract updateLeaseAgreementById(id: number, dto: CreateLeaseAgreementDTO): Promise<LeaseAgreement>;
  abstract deleteLeaseAgreementById(id: number): Promise<LeaseAgreement>;
}