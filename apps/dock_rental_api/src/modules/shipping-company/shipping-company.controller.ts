...
export class ShippingCompanyController {
  ...
  @Post()
  public async createShippingCompany(@Body() leaseAgreement: ShippingCompany): Promise<ShippingCompanyDTO> {
  ...
  public async updateShippingCompanyById(@Param() param: { shippingCompanyId: number }, @Body() updateShippingCompany: ShippingCompany): Promise<UpdateResult> {
